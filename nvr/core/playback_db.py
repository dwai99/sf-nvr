...
class PlaybackDatabase:
    ...
    def update_segment_end(
        self, camera_id: str, file_path: str, end_time: datetime, duration_seconds: int, file_size_bytes: int
    ):
    ...
    def get_segments_in_range(self, camera_id: str, start_time: datetime, end_time: datetime) -> List[Dict]:
    ...
    def get_all_segments_in_range(self, start_time: datetime, end_time: datetime) -> Dict[str, List[Dict]]:
    ...
    def get_motion_events_in_range(self, camera_id: str, start_time: datetime, end_time: datetime) -> List[Dict]:
    ...
    def delete_motion_events_in_range(self, camera_id: str, start_time: datetime, end_time: datetime) -> int:
    ...
    def get_deletion_history(self, limit: int = 100, camera_id: Optional[str] = None) -> List[Dict]:
    ...
    def update_bookmark(
        self, bookmark_id: int, label: Optional[str] = None, notes: Optional[str] = None, color: Optional[str] = None
    ) -> bool:
    ...
    def get_bookmarks_in_range(self, camera_id: str, start_time: datetime, end_time: datetime) -> List[Dict]:
    ...
    def get_all_bookmarks_in_range(self, start_time: datetime, end_time: datetime) -> List[Dict]:
    ...
    def repair_missing_end_times(self) -> Dict[str, int]:
        ...
        logger.info(
            f"Repair complete: {results['repaired']} repaired, {results['failed']} failed, {results['missing']} missing files"
        )
        return results
